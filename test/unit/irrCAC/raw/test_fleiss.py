...
class TestFleiss(TestCase):
    def test_fleiss_kappa_raw4raters(self):
        ...
        self.assertEqual(est["coefficient_value"], 0.761, "Wrong " "coefficient value.")
        self.assertEqual(
    ...
    def test_fleiss_kappa_raw4raters_bipolar_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.535, "Wrong CI lower value.")
    ...
    def test_fleiss_kappa_raw4raters_linear_weights(self):
        ...
        self.assertEqual(est["se"], 0.149, "Wrong standard error.")
        self.assertEqual(est["confidence_interval"][0], 0.491, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 1, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw4raters_ordinal_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.527, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 1, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw4raters_quadratic_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.544, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 1, "Wrong CI upper value.")
        self.assertEqual(round(est["p_value"], 5), 1e-04, "Wrong p-value.")
    ...
    def test_fleiss_kappa_raw4raters_radical_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.460, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 1, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw5observers(self):
        ...
        self.assertEqual(est["coefficient_value"], 0.458, "Wrong coefficient value.")
        self.assertEqual(est["se"], 0.120, "Wrong standard error.")
        self.assertEqual(est["confidence_interval"][0], 0.199, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.716, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw_g1g2(self):
        ...
        self.assertEqual(est["se"], 0.150, "Wrong standard error.")
        self.assertEqual(est["confidence_interval"][0], 0.333, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.981, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw_gender(self):
        ...
        self.assertEqual(est["coefficient_value"], 0.129, "Wrong coefficient value.")
        self.assertEqual(est["se"], 0.141, "Wrong standard error.")
        self.assertEqual(est["confidence_interval"][0], -0.172, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.430, "Wrong CI upper value.")
    ...
    def test_fleiss_kappa_raw_ben_gerry(self):
        ...
        self.assertEqual(est["coefficient_value"], 0.649, "Wrong coefficient value.")
