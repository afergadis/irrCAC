...
class TestGwet(TestCase):
    def test_gwet_raw4raters(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.775, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.143, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.461, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_gwet_raw4raters_bipolar_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.900, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.106, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.667, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value')
    ...
    def test_gwet_raw4raters_circular_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.830, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.133, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.538, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value')
    ...
    def test_gwet_raw4raters_linear_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.859, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.117, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.600, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value')
    ...
    def test_gwet_raw4raters_ordinal_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.899, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.107, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.664, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value')
        self.assertEqual(round(est['p_value'], 6), 4e-6, 'Wrong p value.')
    ...
    def test_gwet_raw4raters_quadratic_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.914, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.104, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.685, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_gwet_raw4raters_radical_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.820, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.128, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.537, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_gwet_raw4raters_ratio_weights(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.857, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.122, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.589, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_gwet_raw5observers(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.497, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.122, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.235, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.758, 'Wrong CI upper value.')
    ...
    def test_gwet_raw_g1g2(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.685, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.134, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.396, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.973, 'Wrong CI upper value.')
    ...
    def test_gwet_raw_gender(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.208, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.091, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.014, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_gwet_raw_ben_gerry(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.661, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.184, 'Wrong standard error value.')
        self.assertEqual(
            est['confidence_interval'][0], 0.257, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
