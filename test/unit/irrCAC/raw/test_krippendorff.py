...
class TestKrippendorff(TestCase):
    def test_krippendorff_kappa_raw4raters(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.743, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.146, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], 0.419,
    ...
    def test_krippendorff_kappa_raw4raters_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.549, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_krippendorff_kappa_raw4raters_circular_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.476, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_krippendorff_kappa_raw4raters_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.499, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_krippendorff_kappa_raw4raters_ordinal_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.542, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_krippendorff_kappa_raw4raters_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.561, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_krippendorff_kappa_raw4raters_ratio_weights(self):
        ...
        self.assertEqual(est['se'], 0.140, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], 0.484, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 1, 'Wrong CI upper value.')
    ...
    def test_krippendorff_kappa_raw5observers(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.481, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.114, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], 0.237,
            'Wrong lower value for confidence interval.')
        self.assertEqual(
            est['confidence_interval'][1], 0.724,
            'Wrong upper value for confidence interval.')
    ...
    def test_krippendorff_kappa_raw_g1g2(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.632, 'Wrong '
            'coefficient value.')
        self.assertEqual(est['se'], 0.150, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], 0.306,
            'Wrong lower value for confidence interval.')
        self.assertEqual(
            est['confidence_interval'][1], 0.958,
            'Wrong upper value for confidence interval.')
    ...
    def test_krippendorff_kappa_raw_gender(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.143, 'Wrong '
            'coefficient value.')
        self.assertEqual(est['se'], 0.141, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], -0.158,
            'Wrong lower value for confidence interval.')
        self.assertEqual(
            round(est['confidence_interval'][1], 3), 0.445,
            'Wrong upper value for confidence interval.')
    ...
    def test_krippendorff_kappa_raw_ben_gerry(self):
        ...
        self.assertEqual(
            est['coefficient_value'], 0.665, 'Wrong coefficient value.')
        self.assertEqual(est['se'], 0.180, 'Wrong standard error.')
        self.assertEqual(
            est['confidence_interval'][0], 0.264,
            'Wrong lower value for confidence interval.')
        self.assertEqual(
            est['confidence_interval'][1], 1,
            'Wrong upper value for confidence interval.')
