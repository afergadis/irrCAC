...
class TestBP(TestCase):
    ...
    def test_bp_cont3x3abstractors(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.742, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.928, 'Wrong CI upper value.')
    ...
    def test_bp_cont3x3abstractors_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.845, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.957, 'Wrong CI upper value.')
    ...
    def test_bp_cont3x3abstractors_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.806, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.946, 'Wrong CI upper value.')
    ...
    def test_bp_cont3x3abstractors_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.871, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.964, 'Wrong CI upper value.')
    ...
    def test_bp_cont3x3abstractors_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.773, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.937, 'Wrong CI upper value.')
    ...
    def test_bp_cont3x3abstractors_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.923, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.978, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.363, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.537, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.115, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.412, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_circular_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.379, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.563, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.229, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.465, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_ordinal_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.123, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.422, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.069, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.403, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.303, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.500, 'Wrong CI upper value.')
    ...
    def test_bp_cont4x4diagnosis_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.158, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.462, 'Wrong CI upper value.')
