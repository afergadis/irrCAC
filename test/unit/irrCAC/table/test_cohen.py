...
class TestCohen(TestCase):
    ...
    def test_cohen_cont3x3abstractors(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.68, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.913, 'Wrong CI upper value.')
    ...
    def test_cohen_cont3x3abstractors_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.791, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.953, 'Wrong CI upper value.')
    ...
    def test_cohen_cont3x3abstractors_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.748, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.938, 'Wrong CI upper value.')
    ...
    def test_cohen_cont3x3abstractors_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.822, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.962, 'Wrong CI upper value.')
    ...
    def test_cohen_cont3x3abstractors_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.712, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.925, 'Wrong CI upper value.')
    ...
    def test_cohen_cont3x3abstractors_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.876, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.977, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.341, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.522, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][1], 0.507, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis_circular_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.350, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_cohen_cont4x4diagnosis_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.302, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.512, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis_ordinal_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.269, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.512, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.254, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_cohen_cont4x4diagnosis_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.324, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.515, 'Wrong CI upper value.')
    ...
    def test_cohen_cont4x4diagnosis_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.288, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.538, 'Wrong CI upper value.')
