...
class TestGwet(TestCase):
    ...
    def test_gwet_cont3x3abstractors(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.764, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.935, 'Wrong CI upper value.')
    ...
    def test_gwet_cont3x3abstractors_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.881, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.969, 'Wrong CI upper value.')
    ...
    def test_gwet_cont3x3abstractors_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.842, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.958, 'Wrong CI upper value.')
    ...
    def test_gwet_cont3x3abstractors_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.905, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_gwet_cont3x3abstractors_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.804, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.947, 'Wrong CI upper value.')
    ...
    def test_gwet_cont3x3abstractors_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.942, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.985, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.371, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.542, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.181, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.450, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_circular_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.399, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.578, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_linear_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.267, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.488, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_ordinal_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.189, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.459, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.150, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.447, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_radical_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.323, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.513, 'Wrong CI upper value.')
    ...
    def test_gwet_cont4x4diagnosis_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.221, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.496, 'Wrong CI upper value.')
