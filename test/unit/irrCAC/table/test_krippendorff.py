...
class TestKrippendorff(TestCase):
    ...
    def test_krippendorff_cont3x3abstractors(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.680, "Wrong CI lower value."
        )
        self.assertEqual(
            round(est["confidence_interval"][1], 3), 0.914, "Wrong CI upper value."
        )
    ...
    def test_krippendorff_cont3x3abstractors_bipolar_weights(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.792, "Wrong CI lower value."
        )
        self.assertEqual(
            round(est["confidence_interval"][1], 3), 0.953, "Wrong CI upper value."
        )
    ...
    def test_krippendorff_cont3x3abstractors_linear_weights(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.748, "Wrong CI lower value."
        )
        self.assertEqual(
            round(est["confidence_interval"][1], 3), 0.939, "Wrong CI upper value."
        )
    ...
    def test_krippendorff_cont3x3abstractors_quadratic_weights(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.822, "Wrong CI lower value."
        )
        self.assertEqual(
            round(est["confidence_interval"][1], 3), 0.963, "Wrong CI upper value."
        )
    ...
    def test_krippendorff_cont3x3abstractors_radical_weights(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.713, "Wrong CI lower value."
        )
        self.assertEqual(
            round(est["confidence_interval"][1], 3), 0.926, "Wrong CI upper value."
        )
    ...
    def test_krippendorff_cont3x3abstractors_ratio_weights(self):
        ...
        self.assertEqual(
            round(est["confidence_interval"][0], 3), 0.877, "Wrong CI lower value."
        )
        self.assertEqual(
