...
class TestPA(TestCase):
    ...
    def test_pa2_cont3x3abstractors(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.828, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.952, "Wrong CI upper value.")
    ...
    def test_pa2_cont3x3abstractors_bipolar_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.943, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.984, "Wrong CI upper value.")
    ...
    def test_pa2_cont3x3abstractors_linear_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.914, "Wrong CI lower value.")
    ...
    def test_pa2_cont3x3abstractors_quadratic_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.957, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.988, "Wrong CI upper value.")
    ...
    def test_pa2_cont3x3abstractors_radical_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.878, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.966, "Wrong CI upper value.")
    ...
    def test_pa2_cont3x3abstractors_ratio_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.972, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.992, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis(self):
        ...
        self.assertEqual(est["confidence_interval"][1], 0.652, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_bipolar_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.722, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.816, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_circular_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.690, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.781, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_linear_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][1], 0.777, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_ordinal_weights(self):
        ...
        self.assertEqual(est["se"], 0.024, "Wrong stderr.")
        self.assertEqual(est["confidence_interval"][0], 0.726, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.820, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_quadratic_weights(self):
        ...
        self.assertEqual(est["se"], 0.024, "Wrong stderr.")
        self.assertEqual(est["confidence_interval"][0], 0.741, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.834, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_radical_weights(self):
        ...
        self.assertEqual(est["confidence_interval"][0], 0.620, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.727, "Wrong CI upper value.")
    ...
    def test_pa2_cont4x4diagnosis_ratio_weights(self):
        ...
        self.assertEqual(est["se"], 0.024, "Wrong stderr.")
        self.assertEqual(est["confidence_interval"][0], 0.739, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.833, "Wrong CI upper value.")

    def test_pa2_cont4x4diagnosis_custom_weights(self):
        weights = np.array(
            [
                [1.00, 0.67, 0.33, 0.00],
                [0.00, 1.00, 0.67, 0.33],
        ...
        results = cac.pa2()
        est = results["est"]
        self.assertEqual(est["coefficient_value"], 0.689, "Wrong coeff value.")
        self.assertEqual(est["se"], 0.027, "Wrong stderr.")
        self.assertEqual(est["confidence_interval"][0], 0.635, "Wrong CI lower value.")
        self.assertEqual(est["confidence_interval"][1], 0.742, "Wrong CI upper value.")
