...
class TestScott(TestCase):
    ...
    def test_scott_cont4x4diagnosis(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.339, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.521, 'Wrong CI upper value.')
    ...
    def test_scott_cont4x4diagnosis_bipolar_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.265, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.506, 'Wrong CI upper value.')
    ...
    def test_scott_cont4x4diagnosis_circular_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.347, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.541, 'Wrong CI upper value.')
    ...
    def test_scott_cont4x4diagnosis_linear_weights(self):
        ...
        self.assertEqual(est['se'], 0.054, 'Wrong stderr.')
        self.assertEqual(
            est['confidence_interval'][0], 0.300, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.511, 'Wrong CI upper value.')
    ...
    def test_scott_cont4x4diagnosis_quadratic_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.252, 'Wrong CI lower value.')
        self.assertEqual(
    ...
    def test_scott_cont4x4diagnosis_radical_weights(self):
        ...
        self.assertEqual(est['se'], 0.049, 'Wrong stderr.')
        self.assertEqual(
            est['confidence_interval'][0], 0.322, 'Wrong CI lower value.')
        self.assertEqual(
            est['confidence_interval'][1], 0.514, 'Wrong CI upper value.')
    ...
    def test_scott_cont4x4diagnosis_ratio_weights(self):
        ...
        self.assertEqual(
            est['confidence_interval'][0], 0.287, 'Wrong CI lower value.')
        self.assertEqual(
