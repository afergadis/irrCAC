...
class Test(TestCase):
    ...
    def test_identity(self):
        expected_weights = np.array([[1., 0., 0.], [0., 1., 0.], [0., 0., 1.]])
    ...
    def test_bipolar(self):
        expected_weights = np.array(
            [[1, 0.667, 0], [0.667, 1, 0.667], [0, 0.667, 1]])
